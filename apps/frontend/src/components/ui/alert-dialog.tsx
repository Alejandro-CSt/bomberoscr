...
function AlertDialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "flex flex-col gap-2 p-6 text-center not-has-[+[data-slot=alert-dialog-footer]]:pb-4 max-sm:pb-4 sm:text-left",
        className
      )}
