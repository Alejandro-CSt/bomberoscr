 ...
 *
 * @param timeRange - Number of days to look back for incidents (7, 30, 90, or 365 days, default: 7)
...
export type FeaturedIncident = Awaited<ReturnType<typeof getFeaturedIncidents>>[number];
